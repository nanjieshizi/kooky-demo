...
const props = defineProps({
  ...
  /** KC 终端等传入 themes.dark / themes.light，用于分屏线颜色 */
  theme: { type: Object, default: null },
})

const dividerStyle = computed(() => ({
  '--split-divider-bg': props.theme?.paneSplitDivider ?? 'rgba(255, 255, 255, 0.08)',
}))
...
.split-divider {
  flex-shrink: 0;
  background: var(--split-divider-bg, rgba(255, 255, 255, 0.08));
