...
const checkItems = computed(() => [
  ...
  { label: '项目关联', status: 'passed', message: selectedProject.value ? `已带入协作背景 v${selectedProject.value.snapshot.version}` : '未关联项目，可独立执行' },
...
/* 与协作「创建协作背景」弹窗统一：容器、标题区、表单节奏、底部操作区 */
