...
export function useDeerflowScroll(listRef) {
  ...
  function attachScrollTriggers(messageCount, streamingContent, onScrollTop) {
    function onScroll() {
    ...
    // 消息条数变化（发送、收到新消息、切换会话、加载历史）：
    // 条数增加视为强意图，强制置底；其他情况尊重用户当前滚动位置
